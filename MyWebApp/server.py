...
config = {'database': 'static/database',
		  'person_url': "../static/database/person/000001_0.jpg",
		  'person_folder':'static/database/person',
		  'cloth_folder':'static/daatebase/cloth',
...
def get_result():
	if request.method == 'GET':
		...
		result_path = os.path.join(config['database'], 'result', result_name)
