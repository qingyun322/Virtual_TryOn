...
parser.add_argument('image_folder', type=str, help='Folder to image')
...
def main():
    ...
    for name in image_names:
        if name[-3:] !='jpg':
            continue
        image_path = os.path.join(args.image_folder, name)
        # ------------ load image ------------ #
